...
root_folder = osp.abspath(os.path.dirname(os.path.dirname(os.path.abspath("save_dataset.py"))))
sys.path.append(root_folder)

from read_graph_raw import read_binary_graph_raw, read_binary_heterograph_raw
