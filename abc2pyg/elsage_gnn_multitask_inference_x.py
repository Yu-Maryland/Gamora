...
from dataset_prep import EdgeListDataset
...
import time
import copy
from elsage.el_sage_baseline_x import GraphSAGE
from elsage.el_sage_baseline_x import train as train_el
from elsage.el_sage_baseline_x import test as test_el
...
def main():
    ...
    elsage_model = GraphSAGE(in_dim=dataset[0].num_node_features, #9 for gamora_output
                 hidden_dim=args.hidden_dim, 
