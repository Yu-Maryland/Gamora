...
extern void Gia_EdgelistGraphSAGE( Gia_Man_t * pGia, char *f0, char *f1, char *f2);
extern void Gia_EdgelistMultiLabel( Gia_Man_t * pGia, char *f0, char *f1, char *f2, int multihot);
